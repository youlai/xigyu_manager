...
class FeeRate extends StatefulWidget {
  ///0有取消按钮 1无取消按钮
  int type;
  FeeRate({Key? key, this.type = 0}) : super(key: key);

  @override
  State<FeeRate> createState() => _FeeRateState();
}

class _FeeRateState extends State<FeeRate> {

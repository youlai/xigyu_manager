                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    Expanded(
                                        child:
                                            Text('待废除：${item['WaitFailNum']}')),
                                    Expanded(
                                        child: Text('已废除：${item['FailNum']}')),
                                  ],
                                ),
                                Row(
                                  children: [
                                    Expanded(
                                        child: Text('有效量：${item['ValidNum']}')),
                                    Expanded(
                                        child: Text('日均：${item['DayNum']}')),
                                    Expanded(
                                        child: Text('废除率：${item['FailRate']}')),
                                  ],
                                ),
                                Row(
                                  children: [
                                    Expanded(
                                        child:
                                            Text('未指派：${item['UnAssignNum']}')),
                                    Expanded(
                                        child: Text('待接单：${item['TackNum']}')),
                                    Expanded(
                                        child:
                                            Text('未预约：${item['UnApointNum']}')),
                                  ],
                                ),
                                Row(
                                  children: [
                                    Expanded(
                                        child: Text('待上门：${item['DoorNum']}')),
                                    Expanded(
                                        child:
                                            Text('服务中：${item['ServiceNum']}')),
                                    Expanded(
                                        child: Text('总量：${item['UnEndNum']}')),
                                  ],
                                ),
                                Row(
                                  children: [
                                    Expanded(
                                        child:
                                            Text('待返件：${item['WaitBackNum']}')),
                                    Expanded(
                                        child: Text('留存率：${item['KeepRate']}')),
                                    Expanded(
                                        child: Text('完结率：${item['EndRate']}')),
                                  ],
                                ),
                              ],
                            ),
